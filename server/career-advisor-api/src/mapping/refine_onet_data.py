...
# --- CONFIGURATION ---
# This script will now automatically figure out the correct paths
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_ROOT = os.path.abspath(os.path.join(SCRIPT_DIR, "../../"))

RAW_DATA_PATH = os.path.join(PROJECT_ROOT, "data/Raw/Data regarding occupation and position etc")
OUTPUT_FILE = os.path.join(PROJECT_ROOT, "data/processed/refined_skills_and_interests.txt")
